...
def put_bucket_s3_replication(aws_auth, bucket_name, end_point, json_file="replication.json"):
    """
...
def get_bucket_s3_replication(aws_auth, bucket_name, end_point, json_file="replication.json"):
    """
...
def delete_bucket_s3_replication(aws_auth, bucket_name, end_point, json_file="replication.json"):
    """
